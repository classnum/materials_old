...
* Carnet [Classiques et numériques](http://classnum.hypotheses.org)
...
### Dictionnaires
* Pour consulter les dictionnaires (en particulier le LSJ et le Gaffiot) sous un format numérique, je vous recommande la plateforme [Logeion](http://logeion.uchicago.edu/about).
* Versions numérisées des dictionnaires usuels
...
* [Digital Classicist](http://wiki.digitalclassicist.org/)

<a id="bibliographie-et-zotero"></a>
### Bibliographie et Zotero
* [Zotero](https://www.zotero.org/)
    * Un très complet [tutoriel](http://www.boiteaoutils.info/2012/06/introduction-zotero-30-nouveau-tutoriel/) (également accessible [ici](https://issuu.com/emilienruiz/docs/zotero_19-06-2012))
    * [Les styles de citation](https://www.zotero.org/support/fr/styles)
        * [Citation Styles Library](http://citationstyles.org/)
        ...
        * [Zotero Style Repository](https://www.zotero.org/styles)        
            ...
            * cf. aussi [csl-france](https://trello.com/b/ACMPVFQf/csl-france)
    * Groupes Zotero
...
* [L'Année philologique](http://www.annee-philologique.com/) (à consulter par le portail de la BU)
* [Ancient World Open Bibliographies](https://ancientbiblio.wordpress.com/)

<a id="biblioth%C3%A8ques-en-ligne"></a>
### Bibliothèques en ligne
* [Project Gutenberg](http://www.gutenberg.org/)
    * cf. première [déclaration](http://www.gutenberg.org/wiki/Gutenberg:Project_Gutenberg_Mission_Statement_by_Michael_Hart)
* [TLG](http://www.tlg.uci.edu) – à consulter à partir du portail BU Paris-Nanterre (sur abonnement)
* [Perseus Digital Library](http://www.perseus.tufts.edu/hopper/)
* [PHI Classical Latin Texts](http://latin.packhum.org)
...
* Peter Suber, [Open Access](http://cyber.law.harvard.edu/hoap/Open_Access_(the_book)), 2012
...
* [Web des données](http://fr.wikipedia.org/wiki/Web_des_données)
    * [Linked data](http://linkeddata.org/home)
    * [Linking Open Data cloud diagram](http://lod-cloud.net/)
* Prosopographie
    * [Standards for Networking Ancient Prosopographies. Data and Relations in Greco-Roman Names](http://snapdrgn.net/)
* Données spatiales et systèmes d'information géographique (SIG)
    ...
    * [Pelagios map](http://pelagios.dme.ait.ac.at/maps/greco-roman/)
    * [Pleiades](http://pleiades.stoa.org/)
    * [Google Ancient Places](https://googleancientplaces.wordpress.com/about/)
    * [Hestia](http://hestia.open.ac.uk/)

<a id="ressources-diverses"></a>
### Ressources diverses
* [Format de données](http://fr.wikipedia.org/wiki/Format_de_donnees)
...
* [Atom](https://atom.io) est l'éditeur que nous utilisons ensemble, disponible pour tout système d'exploitation
    * [Guide](http://flight-manual.atom.io/getting-started/sections/atom-basics/)
...
* [Sustainable Authorship in Plain Text using Pandoc and Markdown](http://programminghistorian.org/lessons/sustainable-authorship-in-plain-text-using-pandoc-and-markdown) (tutoriel)

<a id="terminal-unix"></a>
### Terminal Unix
* Pour vous familiariser avec le terminal Unix (également appelé ligne de commande, *shell* et, en l'occurence, *Bash*), suivez ce tutoriel de la plateforme *Programming Historian* : [Introduction to the Bash Command Line](http://programminghistorian.org/lessons/intro-to-bash).
...
<a id="pandoc"></a>
### Pandoc
* [Pandoc](http://pandoc.org) convertit les fichiers d'un format dans un autre.
...
### HTML
* Pour information
    * [HTML - Wikipedia (EN)](http://en.wikipedia.org/wiki/HTML), [HTML - Wikipedia (FR)](https://fr.wikipedia.org/wiki/Hypertext_Markup_Language)
    * Les documents officiels (*specifications*) qui décrivent [HTML 4.01](http://www.w3.org/TR/html401/) et [HTML 5 (en cours d'élaboration)](https://w3c.github.io/html/). Sachez que le XHTML a été une étape d'évolution du HTML.
* Tutoriels
    * À propos du HTML dans les blogs WordPress, dont notre carnet : [Beginning HTML](http://en.support.wordpress.com/beginning-html/) et [Advanced HTML](http://en.support.wordpress.com/advanced-html/)
    * W3C : [HTML Tutorial](http://www.w3schools.com/html/) (en anglais)
    ...
    * Vous pouvez aussi suivre la ou les premières leçons de tutoriels interactifs sur des plateformes comme [Codecademy](https://www.codecademy.com) ou [CodeSchool](https://www.codeschool.com) (en anglais).
    ...
    * Exemples spectaculaires de styles CSS différents : [CSS Zen Garden](http://www.csszengarden.com)
...
* [TEI by Example](https://teibyexample.org/TBE.htm) (tutoriel, exercices et exemples)
    * Module 0 : [Introduction to Text Encoding and the TEI](https://teibyexample.org/modules/TBED00v00.htm)
    * Module 7 : [Critical Editing](https://teibyexample.org/modules/TBED07v00.htm)
    * [TBE validation service](https://teibyexample.org/xquery/TBEvalidator.xq)
...
* Marjorie Burghart, [TEI Critical Apparatus Toolbox](http://ciham-digital.huma-num.fr/teitoolbox/) (outil de visualisation)
    * Cf. son article [The TEI Critical Apparatus Toolbox: Empowering Textual Scholars through Display, Control, and Comparison Features](https://journals.openedition.org/jtei/1520)
...
* [RStudio cheatsheets](https://www.rstudio.com/resources/cheatsheets/)
    * Tour détaillé de l'environnement de travail de RStudio : [en anglais](https://www.rstudio.com/resources/cheatsheets/#ide) et [en français](https://github.com/rstudio/cheatsheets/raw/master/translations/french/rstudio-IDE-cheatsheet.pdf)
* Trouver des réponses, poser des questions
    ...
    * [RSeek.org](http://rseek.org/) (moteur de recherche spécifique)
...
* Hadley Wickham, [*The tidyverse style guide*](http://style.tidyverse.org/)
* [R for Data Science](https://r4ds.had.co.nz) : [modèle d'un projet d'analyse de données](https://r4ds.had.co.nz/introduction.html)
* [Reproducible Research and the Wonders of RMarkdown](https://alycerussell.github.io/ReproducibleResearchOct2019/#1), en particulier [What is this wizardry?!](https://alycerussell.github.io/ReproducibleResearchOct2019/#44), [What is RMarkdown?](https://alycerussell.github.io/ReproducibleResearchOct2019/#46)
...
* [Initiation au langage et objets de R](http://www.math.univ-toulouse.fr/~besse/Wikistat/pdf/st-tutor2-R-init.pdf)
* [Tutoriel du package `tm`](http://edutechwiki.unige.ch/fr/Tutoriel_tm_text_mining_package)
* [Text mining et nuage de mots avec le logiciel R](http://www.sthda.com/french/wiki/text-mining-et-nuage-de-mots-avec-le-logiciel-r-5-etapes-simples-a-savoir)

<a id="latex"></a>
### LaTeX
* Pour produire des PDF avec Pandoc, notamment
* [Installer LaTeX](http://pandoc.org/installing.html)
* [(Xe)LaTeX appliqué aux sciences humaines](http://geekographie.maieul.net/95) (introduction pertinente et francophone, à télécharger librement)
...
<a id="open-refine"></a>
### Open Refine
* [Google Refine/Open Refine](http://openrefine.org)
